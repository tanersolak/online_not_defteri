				...
				<div class="card-body">
					<form action="giris.php" method="POST">
						...
						<div class="form-group">
							...
							<input type="submit" value="Giriş" name="giris-btn" class="btn float giris_btn bg-primary text-white"><br><br>
							<p style="color: white;">Hesabın yoksa <a href="kaydol.php">Kaydol</a>.</p>
						</div>
					</form>
				</div>
			</div>
